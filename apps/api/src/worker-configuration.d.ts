/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/api/src/worker-configuration.d.ts` (hash: de20a41e39472548d12398386580ed8a)
...
interface __BaseEnv_Env {
	...
	HUNSU_GITHUB_CLIENT_SECRET: string;
	HUNSU_GITHUB_PRIVATE_KEY: string;
	HUNSU_GITHUB_WEBHOOK_SECRET: string;
	HUNSU_SESSION_SECRET: string;
	EPHEMERAL_STATE: DurableObjectNamespace<import("./cloudflare").HunsuEphemeralState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare");
		durableNamespaces: "HunsuEphemeralState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HUNSU_PUBLIC_API_URL" | "HUNSU_WEB_URL" | "HUNSU_GITHUB_APP_ID" | "HUNSU_GITHUB_CLIENT_ID" | "HUNSU_GITHUB_APP_SLUG" | "HUNSU_GITHUB_CLIENT_SECRET" | "HUNSU_GITHUB_PRIVATE_KEY" | "HUNSU_GITHUB_WEBHOOK_SECRET" | "HUNSU_SESSION_SECRET">> {}
}
