...
`0.2.0-next.11`. npm versions are immutable. CI never invents or rewrites a
version.
...
~~~sh
npx @hunsu/bridge@0.2.0-next.11 setup --profile preview
~~~
...
~~~sh
git tag -a v0.2.0-next.11 <approved-preview-sha> \
  -m "Release @hunsu/bridge 0.2.0-next.11 candidate"
git push origin v0.2.0-next.11
~~~
...
~~~sh
npm dist-tag add @hunsu/bridge@0.2.0-next.11 next
